...
- JS: Added a way for JS modules to have per VU initialization and object. This can also be used by xk6 modules by implementing [`github.com/ChipArtem/k6/js/modules#HasModuleInstancePerVU`](https://pkg.go.dev/github.com/ChipArtem/k6/js/modules#HasModuleInstancePerVU). (Part of [#1911](https://github.com/k6io/k6/pull/1911))
...
### Moved repo and renamed k6 Go module paths to `github.com/ChipArtem/k6` ([#2010](https://github.com/k6io/k6/pull/2010))
