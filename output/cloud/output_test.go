...
import (
	...
	cloudv2 "github.com/ChipArtem/k6/output/cloud/expv2"
	cloudv1 "github.com/ChipArtem/k6/output/cloud/v1"
...
func TestNewOutputNameResolution(t *testing.T) {
	...
	cases := []struct {
		...
		{
			url: &url.URL{
				Opaque: "github.com/ChipArtem/k6/samples/http_get.js",
			},
			expected: "http_get.js",
		},
		{
			url:      mustParse("http://github.com/ChipArtem/k6/samples/http_get.js"),
			expected: "http_get.js",
		},
		{
