...
import (
	...
	"github.com/ChipArtem/k6/js/modulestest"
...
func TestEventLoopRejectGoError(t *testing.T) {
	...
	loop.WaitOnRegistered()
	require.EqualError(t, err, "Uncaught (in promise) GoError: some error\n\tat github.com/ChipArtem/k6/js/eventloop_test.TestEventLoopRejectGoError.func1 (native)\n\tat <eval>:1:31(2)\n")
}
...
func TestEventLoopRejectThrow(t *testing.T) {
	...
	loop.WaitOnRegistered()
	require.EqualError(t, err, "Uncaught (in promise) GoError: throw error\n\tat github.com/ChipArtem/k6/js/eventloop_test.TestEventLoopRejectThrow.func1 (native)\n\tat <eval>:1:31(2)\n")
}
